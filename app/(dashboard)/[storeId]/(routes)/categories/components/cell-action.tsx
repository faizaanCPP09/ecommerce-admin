//cell-action.tsx page is used for making of the 3rd row of billboard table, using drop-dowm menu from shadcn/ui library.
...
export const CellAction: React.FC<CellActionProps> = ({
    ...
    //DELETE action -> deleting a specific category
